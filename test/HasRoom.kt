...
fun hasRoomTest() {
    val items = Container(false, INVALID_ITEM, Item(1, 1), Item(2, 5), INVALID_ITEM, Item(3, 1))
    println("Has room tests")
    hasRoomNotAlwaysStackable(items)
    hasRoomAlwaysStackable(items)
}

fun hasRoomNotAlwaysStackable(items: Container) {
...
fun hasRoomAlwaysStackable(items: Container) {
